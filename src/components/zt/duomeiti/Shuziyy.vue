       <template>
		...
		<div class="sec guanyu">
			<h1>关于数字影院</h1>
			<h2>突破视觉，沉浸式体验多维度冲击感官</h2>
			<p>数字影院是安装有播放影片设备的特定封闭或半封闭场所，常用在各行业展览或展示厅里，在定制化的投影幕或高清屏幕播放影片内容，为观众提供震撼与沉浸视听盛宴。数字影院能够抓住观众眼球，有效地传达品牌价值、产品信息以及文化历史，让观众能舒适地全身心投入体验当中。</p>
		</div>
