<template>
  <div class="container">
    ...
    <div class="banner" style="position: relative"> <img src="../assets/images/banner.gif" style="width: 100%;position: relative;">
      ...
      <img class="video-play" src="../assets/images/bofang.png" style="position: relative;display: block;position: absolute;top: 50vw;width: 14%;left: 50%;margin-left: -7%;"> </div>
    <div class="boxgd" style="margin-top: 0px;"></div>
    <!--核心业务-->
    <div class="hexin">
      <h1>核心业务</h1>
      <ul>
        <li><a href="zt/shuzizg/guihua.html"><img src="../assets/images/hexin01.jpg"></a></li>
        ...
        <li><a href="zt/duomeiti/chengshixx.html"><img src="../assets/images/hexin02.jpg"></a></li>
        <li><a href="zt/shejiksh/xiaoguotu.html"><img src="../assets/images/hexin03.jpg"></a></li>
        <li style=" margin-left:4%;">
          <p>设计可视化</p>
          <p>用最直接的视觉
            <br /> 语言，呈现巧夺天工的
        ...
        <li><a href="zt/silujiaoyu/jianzhu.html"><img src="../assets/images/hexin04.jpg"></a></li>
        <li><a href="zt/chuangxin/yunxuanran.html"><img src="../assets/images/hexin05.jpg"></a></li>
        <li style=" margin-left:4%;">
          <p>创新业务</p>
          <p>丝路视觉专属的
            <br /> X实验室&云渲染
    ...
    <div class="zizhi">
      ...
      <div style=" width: 90%; margin: 0 5%; padding-top: 20px;">
        ...
        <p>★&nbsp;中国展览馆协会会员单位 </p>
        <p>★&nbsp;国家建设领域信息化标准参制企业 </p>
        <p>★&nbsp;ISO9001：2008 质量管理体系认证</p>
        <p>★&nbsp;ISO14001：2004 环境管理体系认证 </p>
        <p>★&nbsp;美国 Autodesk 正版化示范 ATC 认证单位</p>
        <p>★&nbsp;国家高新技术企业</p>
        <p>★&nbsp;国家双软认证企业</p>
        <p>★&nbsp;国家重点动漫企业</p>
      </div>
