  ...
  <div class="container index-container">
    ...
    <div class="banner" style="position: relative">
      <div class="banner-cover">
        <img src="../assets/images/banner.gif" style="width: 100%;position: relative;">
      </div>
      <div class="wenzi">
        <div class="b-title" style="top:30vw;">用数字定义你的视界</div>
        <img id="video-play" class="video-play" src="../assets/images/bofang.png">
      </div>
    </div>
