<template>
	...
	<div class="container">
		...
		<div class="sec guanyu">
			<h1>关于企业展馆</h1>
			<h2>会呼吸的企业生命场所</h2>
			<p>企业展馆是企业展现自身品牌形象的重要场所，是企业实力与发展蓝图的清晰画像。丝路视觉运用其丰富的展览展示经验，精准解读企业实力、文化与竞争优势，为不同行业的企业打造时代感与企业特色并重的可持续发展的展馆，能够满足于企业后期的使用、运营以及升级功能。</p>
		</div>
		...
		<div class="sec anli">
			<div class="anli-title">
				<img src="../../../assets/images/shuzizg/qiyezg/wuxing.png" class="xing1">
				<h1>案例展示</h1>
				<img src="../../../assets/images/shuzizg/qiyezg/wuxing.png">
				<div class="cle"></div>
			</div>
			<p>为企业提供全方位定制方案</br>打造与众不同的品牌形象交互空间</p>

			<router-link to="/qiyezg/case/1.html">
				<img src="../../../assets/images/shuzizg/qiyezg/img1.jpg" class="anli-pic">
				<div class="anli-sum">
			...
			<router-link to="/qiyezg/case/2.html">
				<img src="../../../assets/images/shuzizg/qiyezg/img2.jpg" class="anli-pic">
				<div class="anli-sum">
					<div class="anli-wenzi">
						<h1>深圳顺络电子展厅</h1>
						<p>深圳顺络电子股份有限公司</p>
			...
			<router-link to="/qiyezg/case/3.html">
				<img src="../../../assets/images/shuzizg/qiyezg/img3.jpg" class="anli-pic">
				<div class="anli-sum">
					<div class="anli-wenzi">
						<h1>北京启迪控股数字展示中心</h1>
						<p>启迪控股股份有限公司</p>
			...
			<div class="anli-yin">
				...
				<router-link to="/qiyezg/case/8.html">
...
.guanyu {
	...
	background: #fff;
	border-radius: 2vw;
	border-bottom: 2vw solid #d90000;
}
