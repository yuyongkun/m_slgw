...
//	_53code.src = "https://tb.53kf.com/code/code/10156292/1";
//	var s = document.getElementsByTagName("script")[0]; 
//	s.parentNode.insertBefore(_53code, s);
//})();
//
$(document).ready(function(){
	$("img[src$='QQ.jpg']").on("click",function(){
		location.href="https://tb.53kf.com/code/client/10156292/1";
	});
	var _old=$(".shejiao-hao img[src$='youxiang.jpg']");
	_old.remove();
//	$.each($("nav ul li"),function(key,val){
//		$(val).children('a').eq(1).remove();
//	})
});
